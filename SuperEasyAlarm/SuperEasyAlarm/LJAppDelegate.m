...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    LJViewController *ljViewController = [[LJViewController alloc] initWithNibName:@"LJViewController" bundle:nil];
    PresetViewController *presetViewController = [[PresetViewController alloc] init];
    
    NSArray *viewControllers = [NSArray arrayWithObjects:presetViewController, ljViewController, nil];
